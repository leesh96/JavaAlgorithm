...
public class B11003 {
	...
	static int[] arr;
	static Deque<data> d;
//	static PriorityQueue<data> baekjoon.queue;
	...
	public static void main(String[] args) throws IOException {
		...
		arr = new int[n];
		d = new ArrayDeque<>();
//		baekjoon.queue = new PriorityQueue<>(((o1, o2) -> o1.value - o2.value));
		...
		for (int i = 0; i < n; i++) {
			...
			d.addLast(input);
//			baekjoon.queue.add(input);
			if (d.getFirst().idx <= i - l) {
				d.removeFirst();
			}
//			if (i >= l) {
//				while (baekjoon.queue.peek().idx < i - l + 1) {
//					baekjoon.queue.poll();
//				}
//			}
			
			bw.write(d.getFirst().value + " ");
//			bw.write(baekjoon.queue.peek().value + " ");
		}
